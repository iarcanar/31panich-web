...
function AdminFab() {
  return (
    <Link
      href="/admin"
      className="fixed bottom-6 left-6 z-50 w-11 h-11 rounded-full bg-purple-950/90 border border-purple-400/30
        flex items-center justify-center text-purple-300 hover:text-white hover:bg-purple-900
