...
export default function Header() {
  ...
  const headerBg = !isHome || scrolled
    ? "bg-[#0a0a0f] shadow-lg"
    : "bg-transparent lg:bg-slate-900 lg:shadow-lg"
  ...
  return (
    ...
    {/* DEV: ปุ่มเข้า admin — ลบ block นี้ออกเมื่อ deploy production */}
    <Link
      href="/admin/products"
      className="fixed left-0 bottom-6 z-40 bg-neutral-800/60 hover:bg-neutral-700/80 text-neutral-400 hover:text-white pl-1.5 pr-2 py-3 rounded-r-lg transition-colors"
      title="จัดการสินค้า"
    >
