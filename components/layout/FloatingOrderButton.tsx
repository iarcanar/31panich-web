...
export default function FloatingOrderButton() {
  ...
  if (!isOpen) {
    return (
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
        {showLine && !isMobile && (
          <div ref={lineRef} className="bg-[#14141f] border border-white/10 rounded-2xl shadow-2xl shadow-black/40 p-5 w-64 animate-[fade-up_0.2s_ease-out]">
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Phone popover */}
      {showPhone && !isMobile && (
        <div ref={phoneRef} className="bg-[#14141f] border border-white/10 rounded-2xl shadow-2xl shadow-black/40 p-5 w-72 animate-[fade-up_0.2s_ease-out]">
          <div className="flex items-center gap-2 mb-3">
