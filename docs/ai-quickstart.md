...
| สั่งงาน/ติดตามงานภายใน (พนักงาน ↔ ทีมทำสื่อ) | **อ่าน [`task-board.md`](./task-board.md) ก่อนแก้เสมอ** — มีกับดัก 4 ข้อ (PUT ลบรูปทิ้ง, ignore field, description เลิกใช้, cache 30s ตอน dev) · โค้ด: `app/admin/tasks/`, `lib/tasks.ts`, `components/admin/tasks/` |
